    ...
    <header className={`site-header-shell${isHome ? " is-home" : ""}${scrolled ? " is-scrolled" : ""}`}>
      ...
      <div className="site-header">
        ...
        <div className="header-actions">
          <HeaderSearch />
          <LanguageSwitcher />
          <a className="header-cta" href={whatsappHref} target="_blank" rel="noreferrer" aria-label={`${t("nav.contact")}: WhatsApp`}><TractorMark size={24}/><span>{t("nav.contact")}</span><ArrowUpRight size={16} /></a>
