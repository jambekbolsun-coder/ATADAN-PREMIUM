...
export function ProductVideo({tractor}:{tractor:Tractor}){
 ...
 const title={ru:`Changfa ${tractor.model} в деталях`,ky:`Changfa ${tractor.model} толук көрүнүшү`,en:`Changfa ${tractor.model} up close`}[locale];
 const note={ru:`Это наша модель Changfa ${tractor.model}. В интерактивном видео крупным планом показаны кабина, обзор и комфорт рабочего места оператора.`,ky:`Бул биздин Changfa ${tractor.model} модели. Интерактивдүү видеодо кабина, көрүнүш жана оператордун иш ордундагы комфорт жакындан көрсөтүлөт.`,en:`This is our Changfa ${tractor.model}. The interactive video shows the cab, visibility and operator comfort up close.`}[locale];
