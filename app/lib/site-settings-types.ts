...
export type SiteSettings = {
  phone: string; address: string; instagram: string; email?: string; workingHours?: string;
...
export const defaultSettings: SiteSettings = {phone:"+996 706 131 404",address:"Бишкек, ул. Шевченко, 114",instagram:"https://www.instagram.com/atadan_kg",email:"",workingHours:"",annualRate:null,downPercent:30,fee:0,method:"annuity",translations:{},media:{}};
