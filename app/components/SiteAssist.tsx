...
const ui = {
  ru: {
    ...
    q: ["Есть гарантия?", "Можно оформить лизинг?", "Есть сервис и запчасти?"],
    a: [
      ...
      "Да. ATADAN помогает с обслуживанием техники и подбором запасных частей.",
    ],
  ...
  ky: {
    ...
    q: ["Кепилдик барбы?", "Лизинг барбы?", "Сервис жана тетиктер барбы?"],
    a: [
      ...
      "Ооба. ATADAN тейлөөгө жана запастык бөлүктөрдү тандоого жардам берет.",
    ],
  ...
  en: {
    ...
    a: [
      ...
      "Yes. ATADAN helps with machinery service and parts selection.",
    ],
