...
Weight, hydraulics, transmission, tyres and linkage matter as much as the engine. List the three hardest jobs and choose the smallest model that handles them with reserve.`),
  },
  {
    ...
    excerpt: text("Хороший обзор сокращает лишние повороты корпуса, повышает точность работы и делает смену спокойнее.", "Жакшы көрүнүш азыраак бурулуп, так иштеп, сменаны тынч өткөрүүгө жардам берет.", "Better visibility means fewer awkward turns, more precise work and a calmer shift."),
    content: text(
...
## Храните правильно
Фильтры и электрика должны оставаться сухими, а жидкости храниться в закрытой таре. Перед сезоном уточните у ATADAN наличие расходников и срок поставки редких деталей.`,
