  ...
  return (
    <footer className="site-footer" id="contacts">
      ...
      <div className="footer-grid">
        <div className="footer-brand"><div className="footer-logo"><Image className="premium-brand-image" src="/atadan-premium-logo.png" alt="ATADAN, официальный дистрибьютор Changfa" width={1254} height={1254} /></div><span>Official Changfa distributor</span></div>
