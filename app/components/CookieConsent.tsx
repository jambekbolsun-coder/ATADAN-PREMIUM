...
const copy = {
  ru: {
    ...
    details: "Аналитика сохраняет только посещённый путь, модель трактора, выбранный регион и случайный идентификатор: без имени и телефона. WhatsApp, Instagram и карта открываются только по вашему действию.",
